...
//    [self resizeViewObjects];
            [UIView beginAnimations:@"beginRotation" context:NULL];
    ...
    if (self.interfaceOrientation == UIInterfaceOrientationPortrait || self.interfaceOrientation == UIInterfaceOrientationPortraitUpsideDown)
    {
        ...
        _ToneGD.frame = CGRectMake(areawidth + _ToneGD.frame.size.width, thirdrowTopY, dupToneWidth, dupToneheight);
        _ToneDA.frame = CGRectMake(areawidth + _ToneGD.frame.size.width,thirdrowTopY, dupToneWidth, dupToneheight);
        _ToneAE.frame = CGRectMake(areawidth + _ToneGD.frame.size.width,thirdrowTopY, dupToneWidth, dupToneheight);
        ...
        _ToneGD.frame = CGRectMake(areawidth + _ToneGD.frame.size.width, firstrowTopY, dupToneWidth, dupToneheight);
        _ToneDA.frame = CGRectMake(areawidth + _ToneGD.frame.size.width,firstrowTopY + dupToneheight + margin, dupToneWidth, dupToneheight);
        _ToneAE.frame = CGRectMake(areawidth + _ToneGD.frame.size.width,firstrowTopY + dupToneheight*2 + margin*2, dupToneWidth, dupToneheight);
    }
    ...
    _ToneA.frame = CGRectMake(-_ToneA.frame.origin.x - _ToneA.frame.size.width,  -_ToneA.frame.origin.y - _ToneA.frame.size.height, btnwidth, btnheight);
    _ToneD.frame = CGRectMake(-_ToneD.frame.origin.x - _ToneD.frame.size.width,  -_ToneD.frame.origin.y - _ToneD.frame.size.height, btnwidth, btnheight);
    _ToneG.frame = CGRectMake(-_ToneG.frame.origin.x - _ToneG.frame.size.width,  -_ToneG.frame.origin.y - _ToneG.frame.size.height, btnwidth, btnheight);
    _ToneE.frame = CGRectMake(-_ToneE.frame.origin.x - _ToneE.frame.size.width,  -_ToneE.frame.origin.y - _ToneE.frame.size.height, btnwidth, btnheight);
...
-(void)didRotateFromInterfaceOrientation:(UIInterfaceOrientation)fromInterfaceOrientation{
    ...
    [UIView beginAnimations:@"dRotation" context:NULL];
        [self resizeViewObjects];
    [UIView commitAnimations];
}
